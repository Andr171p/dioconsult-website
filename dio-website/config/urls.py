...
from hr_pages import views as vacancies_views
from hr_pages.wagtail_hooks import download_resume
...
urlpatterns = [
    ...
    path("api/", include("hr_pages.urls")),
    ...
    path('admin-tickets/', django_admin.site.urls, name='tickets_admin'),
